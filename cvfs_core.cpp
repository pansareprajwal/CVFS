...
{
    printf("--------------------------------------------------\n");
    printf("------ Prajwal's Virtual File System (CVFS) started successfully ------\n");
    printf("--------------------------------------------------\n");
    ...
    printf("exit   : It is used to terminate Prajwal's Virtual File System (CVFS)\n");
...
void LsFile()
{
    ...
    printf("--------------------------------------------------\n");
    printf("-------- Prajwal's Virtual File System (CVFS) Files Information -------\n");
    printf("--------------------------------------------------\n");
...
//  Description 	: It is used to write data into the file
//  Input           : File descripter, Address of data, size of data
                ...
                )
{
    ...
    printf("Data that want to write : %s\n",data);
    printf("Number of bytes we want to write : %d\n",size);
...
//  Description 	: It is used to read data from the file
//  Input           : File descripter, Address of data, size of data
...
int main()
{
    ...
    while(1)                  
    {
        ...
        if(iCount == 1)
        {
            ...
            {
                printf("Thank you for using Prajwal's Virtual File System (CVFS)\n");
        ...
        {
            // Prajwal's Virtual File System (CVFS) : > creat Ganesh.txt 3
            ...
            // Prajwal's Virtual File System (CVFS) : > read 3 10
